...
public interface UserCouponRedeemStockLedgerMapper extends BaseMapper<UserCouponRedeemStockLedgerDO> {
    int insertIgnore(UserCouponRedeemStockLedgerDO ledger);
    List<UserCouponRedeemStockLedgerDO> selectReadyEvents(@Param("now") Date now, @Param("limit") int limit);
